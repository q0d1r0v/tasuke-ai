// Regenerated-by-hand note: upstream shipped this file with
// `required final X y` named parameters, which Dart 3.13 rejects
// ("Can't have modifier 'final' here"). The modifier was a no-op on a
// named parameter, so removing it changes nothing but the parse.
